...
if (!isset($_GET['edit']) || $_GET['edit'] == null) {
    echo '<script>window.location="selectproduct.php.php";</script>';
} else {
    $id = $_GET['edit'];
} ?>
    ...
    <div class="col-md-4 offset-md-4">
        <div class="singup-form">
            ...
            <form method="post" class="mt-5 border p-4 bg-light shadow">
                <h3 class="col-md-8">تنزيل منتج</h3>
                <div class="row">
                    <div id='result'></div>
                    ...
                    <div class="mb-3 col-md-12">
                        ...
                        ?>
                                ...
                                <?php if (empty($result['ProductName1']) || empty($result['ProductNumber1'])) { ?>
                                    <input id="ProductNumber1" type="hidden" inputmode="decimal" pattern="[0-9]*[.,]?[0-9]*" class="mt-1  form-control float-end" name="ProductNumber1" value="0">
