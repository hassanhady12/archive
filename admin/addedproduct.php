    ...
    <div class="col-md-4 offset-md-4">
        <div class="singup-form">
            <form method="post" class="mt-5 border p-4 bg-light shadow">
                <h3 class="col-md-8 mb-3">راجع جدران</h3>
                <div class="row">
                    <div class="mb-3 col-md-12">
                        ...
                        <input id="submit" class="mt-3 col-12  float-end btn btn-primary" name="submit" type="submit" value="راجع">
                    </div>
                </div>
            </form>
        </div>
